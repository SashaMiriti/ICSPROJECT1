      ...
      return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-4">
          <div className="bg-white p-8 rounded-lg shadow-md text-center max-w-xl w-full">
            ...
            <p className="text-gray-700 mb-6 text-lg">Welcome! Complete your profile to start finding caregivers.</p>
            <div className="flex flex-col gap-6 mb-6">
              <Link to="/care-seeker/profile" className="w-full bg-green-700 text-white text-xl font-bold py-4 rounded hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-400" aria-label="Complete your profile and find caregivers">Complete Profile & Find Caregivers</Link>
